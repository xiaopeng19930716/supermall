  ...
  >
    <el-form :model="form" :rules="rules" ref="form" size="mini" label-width="80px">
      ...
      <el-form-item label="部门">
        <DeptPicker :defaultSelect="form.deptname" @handleSelectChange="selectChange"></DeptPicker>
      </el-form-item>
      <el-form-item label="卡号">
        <el-input v-model="form.cardcode" maxlength="20"></el-input>
      </el-form-item>
...
<script>
import { DeptPicker } from "../dept/index";
export default {
  name: "UserDialog",
  components: {
    DeptPicker
