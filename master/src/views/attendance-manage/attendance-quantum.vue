<template>
  ...
  <div class="panel">
    <DeleteDialog
      :dialog="delDialog"
      :row="deleteRow"
      @onSubmit="delQuantumAsync"
    ></DeleteDialog>
    <QuantumDialog
      :dialog="addDialog"
      @onSubmit="addQuantumAsync"
    ></QuantumDialog>
    <QuantumDialog
      :dialog="editDialog"
      :form="editForm"
      @onSubmit="updateQuantumAsync"
    ></QuantumDialog>
    <el-button-group>
      <el-button
        type="primary"
        size="mini"
        @click="handleDeleteQuantum"
      >删除</el-button>
      <el-button
        type="primary"
        size="mini"
        @click="handleAddQuantum"
      >增加</el-button>
    </el-button-group>
    <MultipleTable
      :header="header"
        ...
        >
          <template slot-scope="scope">
            <el-button
              type="primary"
              size="mini"
              @click="handleEditQuantum(scope.row)"
            >时间段详情</el-button>
          </template>
        </el-table-column>
      </template>
